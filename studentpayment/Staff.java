...
public class Staff {
	...
	public static boolean searchPassword(String password){     
		boolean exist=false;
		for(StaffDetails staff:staffList) {
			if(staff.password.equalsIgnoreCase(password))
			{
			exist=true;
			break;
			}
	...
	public static boolean searchMobNo(String MobNo) {
		...
		boolean exist=false;
		for(StaffDetails staff:staffList) {
			if(String.valueOf(staff.mobNo).equals(MobNo)) {
				exist=true;
				break;
			}
		}
	...
	public static boolean changePassword(String oldPassword,String newPassword){ 
		...
		if(isExist) {
		for(StaffDetails staff:staffList) {
		if(staff.password.equalsIgnoreCase(oldPassword))
		{
	...
	public static boolean validate(String mobNo,String password) {              
		...
		for(StaffDetails staff:staffList){
		if((staff.mobNo==Long.parseLong(mobNo))&&(staff.password.equalsIgnoreCase(password))){
			exist=true;
		}}
		if(exist){
